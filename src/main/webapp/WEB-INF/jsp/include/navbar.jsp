    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="myNavBar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/../performance/performanceList">| Performances</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <a class="nav-link" href="/login/logout">| Logout |&nbsp&nbsp User :&nbsp<b><sec:authentication
                                property="principal.username"/></b></a>
